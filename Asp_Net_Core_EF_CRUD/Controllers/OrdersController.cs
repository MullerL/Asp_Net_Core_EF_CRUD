...
using Asp_Net_Core_EF_CRUD.Models;

namespace Asp_Net_Core_EF_CRUD.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var appDbContext = _context.Orders.Include(o => o.Customer).Include(o => o.Employee).Include(o => o.ShipViaNavigation);
